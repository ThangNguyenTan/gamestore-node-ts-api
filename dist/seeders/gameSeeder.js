...
exports.generateGames = void 0;
const models_1 = require("../models");
const gameData = [
    {
        gameName: 'KINGDOM HEARTS HD 2.8 Final Chapter Prologue',
        gamePrice: 9.99,
        gamePoster: 'https://cdn1.epicgames.com/c8ff067c1c984cd7ab1998e8a9afc8b6/offer/EGS_KINGDOMHEARTSHD28FinalChapterPrologue_SquareEnix_S6-1200x1600-a3fc8fc218fe1ff3541dc2b5b9f076d7.jpg?h=854&resize=1&w=640',
    ...
    },
    {
        gameName: 'NBA 2K21',
        gamePrice: 29.99,
        gamePoster: 'https://cdn1.epicgames.com/salesEvent/salesEvent/EGS_NBA2K21_VisualConcepts_S2_1200x1600-2fed3198782328f4f59194ebd5e54680?h=854&resize=1&w=640',
    ...
    },
    {
        ...
        gamePrice: 39.99,
        gamePoster: 'https://cdn1.epicgames.com/epic/offer/RDR2PC1227_Epic Games_860x1148-860x1148-b4c2210ee0c3c3b843a8de399bfe7f5c.jpg?h=854&resize=1&w=640',
    ...
    },
    {
        ...
        gamePrice: 19.99,
        gamePoster: 'https://cdn1.epicgames.com/undefined/offer/S2_ACOD-1280x1440-621a727d381ffe0cffe869c1e23bc741.jpg?h=854&resize=1&w=640',
...
const generateGames = async () => {
    gameData.forEach(async (gameItem) => {
        await models_1.GameInstance.create(gameItem);
    });
};
exports.generateGames = generateGames;
